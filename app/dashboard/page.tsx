...
import { MessageCircleIcon, UserIcon, UsersIcon, SettingsIcon, ArrowRightIcon } from "@/lib/icons"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8 flex items-center justify-between">
          ...
          <Button onClick={handleGoToChat} className="bg-whatsapp-green hover:bg-whatsapp-green-dark">
            Go to Chat
